...
# Database
DB_URI = os.environ.get("DATABASE_URL", "postgres://pzqqgirb:i-9YYHgA92aOx348--ZK7aaIoHGuzgzy@castor.db.elephantsql.com/pzqqgirb")

PROTECT_CONTENT = strtobool(os.environ.get("PROTECT_CONTENT", "False"))

# ID dari Channel Atau Group Untuk Wajib Subscribenya
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001810996163"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001612785738"))
FORCE_SUB_3 = int(os.environ.get("FORCE_SUB_3", "-1001988336696"))
